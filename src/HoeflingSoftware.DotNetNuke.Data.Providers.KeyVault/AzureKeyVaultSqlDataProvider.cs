...
namespace HoeflingSoftware.DotNetNuke.Data.Providers
{
    ...
    {
        private static readonly ILog Logger = LoggerSource.Instance.GetLogger(typeof(AzureKeyVaultSqlDataProvider));
        ...
        public override Dictionary<string, string> Settings
        {
            get
            {
                return ComponentFactory.GetComponentSettings<AzureKeyVaultSqlDataProvider>() as Dictionary<string, string>;
            }
        }
